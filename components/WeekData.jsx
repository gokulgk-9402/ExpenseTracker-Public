...
const WeekData = () => {
  return (
    <div className=" w-[calc(100%-2rem)] h-[calc(100vh-17.5rem)] mt-10 bg-slate-900 rounded-2xl flex flex-col px-4 py-6 gap-4 md:max-w-5xl md:flex-row md:bg-transparent md:px-0 md:h-[40rem]">
      ...
      <div className=" w-full h-3/5 md:bg-slate-900 md:rounded-2xl md:w-1/2 overflow-auto md:h-full">
        <div className=" flex flex-row justify-between bg-slate-700 h-20 py-4 px-4 items-center rounded-2xl md:rounded-none">
          ...
          <button className=" bg-green-600 px-4 py-2 text-slate-200 rounded-lg">
            + Add New
          </button>
        </div>
        <Category />
